    ...
    <>
      ...
      <section className="bg-background section-padding-y">
        <div className="container-padding-x mx-auto max-w-3xl flex flex-col gap-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            Past-due balances may be subject to a late fee of 1.5 percent per month (18 percent per year) or the maximum allowed by Colorado law, whichever is less. Trailhead may suspend further service, withhold warranty coverage, or refer the account to collections for any account in arrears.
          </p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">7. Workmanship Warranty</h2>
          <p>
            Trailhead warrants its labor and workmanship on installations and repairs for 90 days from the date of completion. If a defect in our workmanship arises during this period, we will return and correct the issue at no charge to you. Parts and materials are covered by their respective manufacturer warranties, which Trailhead will assist you in claiming where applicable.
          </p>
          <p>
            The workmanship warranty does not cover: damage caused by freezing or improper winterization not performed by us; damage from third parties, lawn equipment, vehicles, animals, or weather events; vandalism; modifications made by anyone other than Trailhead after our work was completed; or normal wear and tear.
          </p>

          <h2 className="text-2xl font-bold text-foreground mt-6">8. PVC Pipe Exclusion</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">9. Insurance and Property Damage</h2>
          <p>
            Trailhead is fully insured with general liability coverage. We take reasonable care during all work. In the event of accidental damage caused by our team during the course of service, we will work with you in good faith to repair or replace the damaged item, subject to the limits in Section 10 below.
          </p>
          <p>
            Trailhead is not responsible for: damage to unmarked or improperly marked underground utilities, irrigation lines, sprinkler heads, or other improvements; damage to existing systems that fail due to age or pre-existing conditions; pre-existing damage; or damage caused by weather, freezing, vehicles, animals, third parties, or events outside our control.
          </p>

          <h2 className="text-2xl font-bold text-foreground mt-6">10. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">11. Disclaimer of Other Warranties</h2>
          <p>
            Except for the express workmanship warranty in Section 7, Trailhead provides all services &quot;as is&quot; and disclaims all other warranties, express or implied, including any implied warranties of merchantability, fitness for a particular purpose, and non-infringement. We do not warrant that your lawn or plants will remain green, healthy, or alive, as outcomes depend on many factors outside our control including weather, drought stage restrictions, water supply, soil, customer maintenance, and plant condition.
          </p>

          <h2 className="text-2xl font-bold text-foreground mt-6">12. Indemnification</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">13. Force Majeure</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">14. Photos and Marketing Use</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">15. Governing Law and Dispute Resolution</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">16. Modifications</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">17. Severability and Entire Agreement</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-6">18. Contact</h2>
          <p>
