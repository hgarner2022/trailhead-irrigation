...
const PRICING_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Winterization (sprinkler blowout) costs $95 for up to 6 zones, plus $10 for each additional zone. We recommend scheduling between late September and October, before the first hard freeze.",
    relatedLink: {
            ...
            {PRICING_FAQS.map((faq) => (
              ...
              >
                ...
                <div className="px-5 pb-5">
                  ...
                  {"relatedLink" in faq && faq.relatedLink && (
                    <Link
                      href={faq.relatedLink.href}
                      className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-primary hover:text-primary-dark transition-colors"
                    >
