...
export const CITY_DATA: CityData[] = [
  {
    ...
    waterProviderPhone: "303-926-2871",
    ...
    backflowDeadline: "Colorado state law requires annual testing. Contact the Town of Erie at 303-926-2871 for the local compliance deadline.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes. Colorado state law requires annual backflow testing for all irrigation systems connected to municipal water. Contact the Town of Erie at 303-926-2871 for your specific deadline.",
      },
    ],
  ...
  },
  {
    ...
    waterProviderPhone: "888-966-6050",
    waterProviderEmail: "support@backflow.com",
    ...
    backflowDeadline: "Testing cycle runs January through August. Results submitted through BSI Online (backflow.com). Non-compliance can result in fees and water service interruptions.",
